...
const routes = [
  ...
  { path: '/search', name: 'search', component: () => import('../views/SearchView.vue') },
  {
    ...
    children: [
      ...
      { path: 'shop', name: 'admin-shop', component: () => import('../views/admin/ShopView.vue') },
      ...
      { path: 'ledger', name: 'admin-ledger', component: () => import('../views/admin/LedgerView.vue') },
      { path: 'invites', name: 'admin-invites', component: () => import('../views/admin/InvitesView.vue') },
      { path: 'settings', name: 'admin-settings', component: () => import('../views/admin/SettingsView.vue') },
      { path: 'export', name: 'admin-export', component: () => import('../views/admin/ExportView.vue') },
      { path: 'broadcast', name: 'admin-broadcast', component: () => import('../views/admin/BroadcastView.vue') },
      { path: 'modlogs', name: 'admin-modlogs', component: () => import('../views/admin/ModLogsView.vue') },
    ],
  },
]
